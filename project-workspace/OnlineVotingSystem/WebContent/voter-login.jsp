...
<body class="host_version">
	...
	<div class="container">
		<div class="row pad-botm">
			<div class="col-md-12">
				<h4 class="header-line">Voter Login</h4>
			</div>
		</div>
		<div class="row">
			<div class="col-md-6 col-sm-6 col-xs-12">
				<img src="images/voter-login.png" style="width:500px;height:400px;">
			</div>
			<div class="col-md-6 col-sm-6 col-xs-12">
						...
						<form action="VoterLogin" method="post">
							<div class="form-group">
								<label>User Name</label> <input class="form-control"
									type="text" name="uname" placeholder="User Name" required/>
							</div>
							<div class="form-group">
								<label>Password</label> <input class="form-control"
									type="password" name="upass" placeholder="Password" required/>
							</div>
							<%
								String captcha = null;
							...
							<a class="for-pwd" href="voter-registration.jsp">New Voter Register</a>
						</form>
					</div>
				</div>
			</div>
