					...
					<div class="row">
						<div class="col-md-12 col-sm-12 text-center">
							<div class="big-tagline">
								...
								<p class="lead" data-animation="animated fadeInLeft">Electronic
									Voting Machine (also known as EVM) is voting using electronic
									means to either aid or take care of the chores of casting and
									counting votes.</p>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 text-center">
							<div class="big-tagline">
								...
								<p class="lead" data-animation="animated fadeInLeft">An EVM
									is designed with two units: the control unit and the balloting
									unit.</p>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 text-center">
							<div class="big-tagline">
								...
								<p class="lead" data-animation="animated fadeInLeft">The
									control unit of the EVM is kept with the presiding officer or
									the polling officer.</p>
							</div>
						</div>
					</div>
					<!-- end row -->
		...
		<div class="row">
			<div class="col-md-4 col-sm-6 col-xs-12">
				<div class="icon-wrapper wow fadeIn" data-wow-duration="1s"
					data-wow-delay="0.2s">
					<i class="flaticon-server global-radius effect-1 alignleft"></i>
					<h3>REPUBLICAN PARTY OF INDIA PARTY</h3>
				</div>
				<!-- end icon-wrapper -->
			</div>
			<div class="col-md-4 col-sm-6 col-xs-12">
				<div class="icon-wrapper wow fadeIn" data-wow-duration="1s"
					data-wow-delay="0.2s">
					<i class="flaticon-server global-radius effect-1 alignleft"></i>
					<h3>VOTERS INDEPENDENT PARTY</h3>
				</div>
				<!-- end icon-wrapper -->
			</div>
		</div>
